<template>
    <div class="sld_login">
        ...
        <div class="sld_login_content">
            <img class="bg" :src="configInfo.main_user_forget_password_bg" :onerror='defaultBgImg' alt />
            <div class="login">
                <div class="login_box">
                    <div class="top">
                    ...
                    <div class="center">
                        ...
                        <div class="item password">
                            ...
                            <input :type="showPwdFlag?'text':'password'" v-model="password"
                                :placeholder="L['请输入6～20位英文、数字、符号']" class="input">
                            <div class="cancel" @click="isShowPwd">
                                <span :style="{color: '#bbb',fontSize:showPwdFlag?'20px':'16px'}"
                                    :class="{iconfont:true,'icon-bukejian11':!showPwdFlag,'icon-kejian':showPwdFlag,show_pwd:showPwdFlag}"></span>
                            </div>
                        </div>
                        <div class="error">
                        ...
                        <a href="javascript:void(0)" @click="login" class="login_btn">{{L['找回密码']}}</a>
                    </div>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const defaultBgImg = ref('this.src="' + require('../../../assets/forget_pwd_bg.png') + '"')
            const login = () => {
                let param = {};
                ...
                proxy.$post('v3/member/front/memberPassword/resetLoginPwd', param).then(res => {
                    if (res.state == 200) {
                        //成功提示，并返回到登录页面
