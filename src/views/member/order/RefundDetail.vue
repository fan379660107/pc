            ...
            <div class="refund_speed">
                ...
                <div class="refund_speed_con flex_row_center_start">
                    ...
                    <div class="refund_speed_pre flex_column_center_center">
                        ...
                        <span
                            :class="{refund_noactive:refundDetail.data.state == 100 || refundDetail.data.state == 101}">{{L['审核中']}}</span>
                    </div>
                    <div class="refund_speed_line">
                    ...
                    <div class="refund_speed_pre flex_column_center_center">
                        ...
                        <span
                            :class="{refund_noactive:refundDetail.data.state!=300 && refundDetail.data.state!=202}">{{L['完成']}}</span>
                    </div>
            ...
            <div class="refund_journal_con">
                <div class="refund_journal_pre flex_row_start_start"
                    ...
                    <div class="journal_right">
                        ...
                        <div class="journal_time" v-show="logItem.applyReasonContent"
                            :title="logItem.applyReasonContent">{{L['退款原因']}}：{{logItem.applyReasonContent}}</div>
                        ...
                        <div class="journal_time refund_voucher flex_row_start_start"
                            ...
                            <div class="refund_voucher_list flex_row_start_start">
                                <div class="refund_voucher_pre"
                                    v-for="(applyImgItem,applyImgIndex) in logItem.applyImageList" :key="applyImgIndex">
                                    <el-image :src="applyImgItem" :preview-src-list="logItem.applyImageList"
                                        fit="cover"></el-image>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        setup() {
            ...
            const getRefundOrderDetail = () => {
                ...
                proxy.$get('v3/business/front/after/sale/detail', params).then((res) => {
                    if (res.state == 200) {
